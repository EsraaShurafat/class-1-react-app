...
class HornedBeast extends React.Component{
    render(){
        return( <>
        <div className='horn 1'> HornedBeast {this.props.HornedBeastNumber}
        <h2>UniWhal</h2>
        <img src='http://3.bp.blogspot.com/_DBYF1AdFaHw/TE-f0cDQ24I/AAAAAAAACZg/l-FdTZ6M7z8/s1600/Unicorn_and_Narwhal_by_dinglehopper.jpg' alt title></img>
        <p>A unicorn and a narwhal nuzzling their horns</p>
        </div>
        <div className='horn 2'>HornedBeast {this.props.HornedBeastNumber}
            <h2>Rhino Family</h2>
        ...
        <div className='horn 3'> HornedBeast {this.props.HornedBeastNumber}
            <h2>Unicorn Head</h2>
